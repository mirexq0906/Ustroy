...
<header>
        ...
        <div class="container">
            <div class="row">
                <div class="header-top">
                    ...
                    <div class="header-block">
                        <ul class="top-menu">
                            <li><a href="#section1_scroll">Что делаем?</a></li>
                            <li><a href="#section2_scroll">Мы построили</a></li>
                            <li><a href="#section3_scroll">О компании</a></li>
                            <li><a href="#section4_scroll">Производство</a></li>
                        </ul>
                    </div>
                    <div class="header-block">
    ...
    <div class="container" id="position">
        <div class="row">
            <div class="header-top revealator-slidedown revealator-once">
                <div class="header-block">
                    <a href="#" class="logo">Универсал-строй</a>
                </div>
                <div class="header-block">
                    <ul class="top-menu">
                        <li><a href="#section1_scroll">Что делаем?</a></li>
        ...
        <div class="row">
            <div class="slogan revealator-slideright revealator-once"><h1><span>Строим</span> и <span>управляем</span> <br>проектами любой <br>сложности!</h1></div>
            <div class="click-bottom">Листайте вниз</div>
        </div>
    </div>
</header>
<?= $content; ?>
